...
class V1TrendFollowingAlgorithm(QCAlgorithm):  # type: ignore[misc,name-defined]  # noqa: F405
    ...
    def initialize(self):
        ...
        for ticker in PHASE1_FUTURES:
            ...
            # MappedSymbol column is ``mes``, so the lookup misses and
            ...
            # See ``Docs/decisions-log.md`` 2026-05-22 entry "bar_sync map_file
            # synthesis lands" + the follow-up entry for this fix.
            #
