...
| **P2** | LEAN driver + §6.6 vbt↔LEAN parity + reproduce V1 | **built + real-engine accepted + trust bridge MEASURED** (parity PASS 2026-06-04; PR D 2026-06-11: date+market match **4/5 markets** CI [0.28, 0.99] / 4/10 strict, **side-verified 2/10** (TLT side-FLIPPED — bars revised since live decided), ER-aligned window 1/1 side-verified, **zero unexplained residual** after attribution; see [`lean/README.md`](lean/README.md) "Measured trust bridge") |
