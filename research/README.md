...
| **P2** | LEAN driver + §6.6 vbt↔LEAN parity + reproduce V1 | **built + real-engine accepted + trust bridge MEASURED** (parity PASS 2026-06-04; PR D 2026-06-11: market-level match **4/5 = 80%** CI [0.28, 0.99], strict 4/10, ER-aligned window 1/1, **zero unexplained residual** after attribution; see [`lean/README.md`](lean/README.md) "Measured trust bridge") |
